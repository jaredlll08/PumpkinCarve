...
public class GuiObjectErase extends GuiObject {
    
    public GuiObjectErase(GuiCarve parent, int x, int y, int width, int height) {
        super(parent, x, y, width, height);
    }
    
    @Override
    public void draw(int left, int top, int mouseX, int mouseY, float partialTicks) {
        if(parent.currentMode == EnumMode.ERASE) {
        ...
        mc.fontRenderer.drawString("E", (int) getX()+ mc.fontRenderer.getStringWidth("E")/2, (int) getY()+10-mc.fontRenderer.FONT_HEIGHT, 0);
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        parent.currentMode = EnumMode.ERASE;
    }
}
